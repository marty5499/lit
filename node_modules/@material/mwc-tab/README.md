...
`--mdc-tab-text-label-color-default` | ![](https://raw.githubusercontent.com/material-components/material-components-web-components/9830d665867dbb440855339d9181b5c323202008/packages/tab/images/color_0,0,0,60.png) `rgba(0, 0, 0, 0.6)`  | Color of an unactivated tab label.
`--mdc-tab-color-default`            | ![](https://raw.githubusercontent.com/material-components/material-components-web-components/9830d665867dbb440855339d9181b5c323202008/packages/tab/images/color_0,0,0,54.png) `rgba(0, 0, 0, 0.54)` | Color of an unactivated icon.
